...
const customerSalesTemplate = (customerSales, fromDate, toDate) => {
    let title = "SALES BY CUSTOMERS FROM " +
      ...
      <div class="invoice-box">
         <table cellpadding="0" cellspacing="0">
            ...
            ${customerSales.map((customer) => {
                ...
                totalAmount += Number(customer.amount);
                return (`
                    <tr>
                        <td>${customer.customerID}</td>
                        <td>${customer.customerName}</td>
                        <td class="text-right">${customer.quantity}</td>
